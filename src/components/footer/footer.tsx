    ...
    <div className="container">
        ...
        <div className="d-flex justify-content-between flex-wrap align-items-center">
            ...
            <div className="col-lg d-flex justify-content-end">
                <p>
                    <a href="https://github.com/Kubaleek" target='_blank' className="me-3" title="Github"> 
                        <i className="bi bi-github"></i>
                    </a>
                    <a href="https://www.instagram.com/kubalekweb/" target='_blank' className="me-3" title="Instagram">
